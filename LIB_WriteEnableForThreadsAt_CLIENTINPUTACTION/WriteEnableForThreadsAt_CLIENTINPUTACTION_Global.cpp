...
unsigned char Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Global::Get_NumCores()
{
    return _num_Implemented_Cores;
}
std::vector<bool> Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Global::Get_flag_write_IDLE()
{
    return _flag_write_IDLE;
}
std::vector<bool> Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Global::Get_flag_write_WAIT()
{
    return _flag_write_WAIT;
}
std::vector<bool> Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Global::Get_flag_write_WRITE()
{
