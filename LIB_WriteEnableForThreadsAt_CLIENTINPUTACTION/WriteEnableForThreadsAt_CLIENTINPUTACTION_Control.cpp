#include "pch.h"
    ...
    Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::~WriteEnableForThreadsAt_CLIENTINPUTACTION_Control()
    {

    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::WriteEnable_Activate(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char coreId)
    {
    ...
    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::WriteEnable_SortQue(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
    ...
    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::WriteEnable_Request(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char coreId)
    {
    ...
    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::WriteQue_Update(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj)
    {
    ...
    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::DynamicStagger(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char coreId)
    {
        if (obj->Get_writeEnable()->Get_writeEnable_Control()->Get_writeCycle_Try_CoreId_Index() == coreId)
        {
            //exit early
    ...
    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::WriteEnable_ShiftQueValues(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char coreId_A, unsigned char coreId_B)
    {
        int temp_A = int(0);
    ...
    unsigned char Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_writeCycle_Try_CoreId_Index()
    {
        return _writeCycle_Try_CoreId_Index;
    }

    int Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_count_CoreId_WriteActive(unsigned char coreId)
    {
        return _count_CoreId_WriteActive[coreId];
    }

    int Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_count_CoreId_WriteIdle(unsigned char coreId)
    {
        return _count_CoreId_WriteIdle[coreId];
    }

    int Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_count_CoreId_WriteWait(unsigned char coreId)
    {
        return _count_CoreId_WriteWait[coreId];
    }

    bool Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_flag_praisingWrite()
    {
        return _flag_praisingWrite;
    }

    std::vector<bool> Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_flag_WriteState(unsigned char coreId)
    {
        return _flag_WriteState[coreId];
    }

    unsigned char Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_new_writeCycle_Try_CoreId_Index()
    {
        return _new_writeCycle_Try_CoreId_Index;
    }

    unsigned char Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Get_que_CoreToWrite(unsigned char coreId)
    {
        return _que_CoreToWrite[coreId];
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_writeCycle_Try_CoreId_Index(unsigned char writeCycle_Try_CoreId_Index)
    {
        _writeCycle_Try_CoreId_Index = writeCycle_Try_CoreId_Index;
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_count_CoreId_WriteActive(unsigned char coreId, int count_CoreId_WriteActive)
    {
        _count_CoreId_WriteActive[coreId] = count_CoreId_WriteActive;
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_count_CoreId_WriteIdle(unsigned char coreId, int count_CoreId_WriteIdle)
    {
        _count_CoreId_WriteIdle[coreId] = count_CoreId_WriteIdle;
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_count_CoreId_WriteWait(unsigned char coreId, int count_CoreId_WriteWait)
    {
        _count_CoreId_WriteWait[coreId] = count_CoreId_WriteWait;
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_flag_praisingWrite(bool flag_praisingWrite)
    {
        _flag_praisingWrite = flag_praisingWrite;
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_flag_WriteState(unsigned char coreId, std::vector<bool> flag_WriteState)
    {
        _flag_WriteState.at(coreId) = flag_WriteState;
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_new_writeCycle_Try_CoreId_Index(unsigned char new_writeCycle_Try_CoreId_Index)
    {
        _new_writeCycle_Try_CoreId_Index = new_writeCycle_Try_CoreId_Index;
    }

    void Avril_FSD::WriteEnableForThreadsAt_CLIENTINPUTACTION_Control::Set_que_CoreToWrite(unsigned char coreId, unsigned char que_CoreToWrite)
    {
