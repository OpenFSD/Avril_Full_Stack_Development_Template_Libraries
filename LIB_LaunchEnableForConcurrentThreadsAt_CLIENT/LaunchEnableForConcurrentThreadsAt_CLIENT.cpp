...
void Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Initialise_Control()
{
    Create_Control_Of_LaunchConcurrency();
}

void Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Thread_Start(Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Framework* obj, unsigned char concurrent_CoreId)
{
...
void Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Thread_End(Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Framework* obj, unsigned char concurrent_CoreId)
{
...
void Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Create_LaunchEnableForConcurrentThreadsAt_CLIENT_Global()
{
    Set_LaunchConcurrency_Global(new class Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Global());
    while (Get__LaunchConcurrency_Global() == NULL) {}
}
void Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Create_Control_Of_LaunchConcurrency()
{
    Set_Control_Of_LaunchConcurrency(new class Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Control(Get__LaunchConcurrency_Global(), Get__LaunchConcurrency_Global()->Get_number_Implemented_Cores()));
    while (Get__Control_Of_LaunchConcurrency() == NULL) { /* wait untill created */ }
}
Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Global* Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Get_LaunchConcurrency_Global()
{
    return ptr_Global;
}
Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Control* Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Get_Control_Of_LaunchConcurrency()
{
    return ptr_LaunchConcurrency_Control;
}
Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Global* Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Get__LaunchConcurrency_Global()
{
    return ptr_Global;
}
Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT_Control* Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Get__Control_Of_LaunchConcurrency()
{
    return ptr_LaunchConcurrency_Control;
}
void Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Set_LaunchConcurrency_Global(LaunchEnableForConcurrentThreadsAt_CLIENT_Global* global)
{
    ptr_Global = global;
}
void Avril_FSD::LaunchEnableForConcurrentThreadsAt_CLIENT::Set_Control_Of_LaunchConcurrency(LaunchEnableForConcurrentThreadsAt_CLIENT_Control* control)
{
