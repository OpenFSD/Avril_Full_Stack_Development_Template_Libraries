...
namespace Avril_FSD
{
    ...
    public:
        ...
        void WriteEnable_Activate(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char coreId);
        void WriteEnable_SortQue(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void WriteEnable_Request(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char coreId);
    ...
    private:
        void DynamicStagger(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char coreId);
        void WriteEnable_ShiftQueValues(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B);
