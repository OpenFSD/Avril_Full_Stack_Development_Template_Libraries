...
namespace Avril_FSD
{
    ...
    {
    public:
        WriteEnableForThreadsAt_SERVERINPUTACTION_Control(class WriteEnableForThreadsAt_SERVERINPUTACTION_Global* global);
        ~WriteEnableForThreadsAt_SERVERINPUTACTION_Control();
        void WriteEnable_Activate(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, unsigned char coreId);
        void WriteEnable_SortQue(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj);
        void WriteEnable_Request(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, unsigned char coreId);
        void WriteQue_Update(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj);
    ...
    private:
        void DynamicStagger(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, unsigned char coreId);
        void WriteEnable_ShiftQueValues(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj, unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B);
