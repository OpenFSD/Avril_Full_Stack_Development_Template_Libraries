#include "pch.h"
    ...
    OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control(class OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Global* global)
    {
    ...
    OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::~WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control()
    {

    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::WriteEnable_Activate(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, unsigned char coreId)
    {
    ...
    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::WriteEnable_SortQue(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj)
    {
    ...
    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::WriteEnable_Request(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, unsigned char coreId)
    {
    ...
    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::WriteQue_Update(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj)
    {
    ...
    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::DynamicStagger(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, unsigned char coreId)
    {
        if (obj->Get_writeEnable()->Get_writeEnable_Control()->Get_writeCycle_Try_CoreId_Index() == coreId)
        {
            //exit early
    ...
    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::WriteEnable_ShiftQueValues(class WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Framework* obj, unsigned char coreId_A, unsigned char coreId_B)
    {
        int temp_A = int(0);
    ...
    unsigned char OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_writeCycle_Try_CoreId_Index()
    {
        return _writeCycle_Try_CoreId_Index;
    }

    int OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_count_CoreId_WriteActive(unsigned char coreId)
    {
        return _count_CoreId_WriteActive[coreId];
    }

    int OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_count_CoreId_WriteIdle(unsigned char coreId)
    {
        return _count_CoreId_WriteIdle[coreId];
    }

    int OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_count_CoreId_WriteWait(unsigned char coreId)
    {
        return _count_CoreId_WriteWait[coreId];
    }

    bool OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_flag_praisingWrite()
    {
        return _flag_praisingWrite;
    }

    std::vector<bool> OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_flag_WriteState(unsigned char coreId)
    {
        return _flag_WriteState[coreId];
    }

    unsigned char OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_new_writeCycle_Try_CoreId_Index()
    {
        return _new_writeCycle_Try_CoreId_Index;
    }

    unsigned char OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Get_que_CoreToWrite(unsigned char coreId)
    {
        return _que_CoreToWrite[coreId];
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_writeCycle_Try_CoreId_Index(unsigned char writeCycle_Try_CoreId_Index)
    {
        _writeCycle_Try_CoreId_Index = writeCycle_Try_CoreId_Index;
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_count_CoreId_WriteActive(unsigned char coreId, int count_CoreId_WriteActive)
    {
        _count_CoreId_WriteActive[coreId] = count_CoreId_WriteActive;
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_count_CoreId_WriteIdle(unsigned char coreId, int count_CoreId_WriteIdle)
    {
        _count_CoreId_WriteIdle[coreId] = count_CoreId_WriteIdle;
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_count_CoreId_WriteWait(unsigned char coreId, int count_CoreId_WriteWait)
    {
        _count_CoreId_WriteWait[coreId] = count_CoreId_WriteWait;
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_flag_praisingWrite(bool flag_praisingWrite)
    {
        _flag_praisingWrite = flag_praisingWrite;
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_flag_WriteState(unsigned char coreId, std::vector<bool> flag_WriteState)
    {
        _flag_WriteState.at(coreId) = flag_WriteState;
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_new_writeCycle_Try_CoreId_Index(unsigned char new_writeCycle_Try_CoreId_Index)
    {
        _new_writeCycle_Try_CoreId_Index = new_writeCycle_Try_CoreId_Index;
    }

    void OpenAvril::WriteEnableForThreadsAt_CLIENTOUTPUTRECIEVE_Control::Set_que_CoreToWrite(unsigned char coreId, unsigned char que_CoreToWrite)
    {
